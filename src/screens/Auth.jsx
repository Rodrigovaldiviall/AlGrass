  ...
  useEffect(() => {
    ...
    supabase.from('game_players')
      ...
      .then(({ data }) => {
        ...
        // reingresar: se excluye del bloqueo (regresión introducida por 2ca56f6a).
          ...
          <div style={{ padding: '10px 20px 16px' }}>
            ...
            <div style={{ marginTop: 16, textAlign: 'center', fontSize: 16 }}>
              <button
                ...
                <span style={{ color: '#D4750A', fontWeight: 700, fontSize: 18, textDecoration: 'underline', textUnderlineOffset: '3px', marginLeft: 10 }}>
