...
export function useAppTimings() {
  const [timings, setTimings] = useState({ freeInvitesLeadMin: null, attendanceLeadMin: null, matchRefundCutoffHours: null, captainReleaseHours: null, captainGoldReleaseHours: null });
  useEffect(() => {
    let alive = true;
